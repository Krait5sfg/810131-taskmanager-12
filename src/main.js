        ...
        <div class="card__settings">
            ...
            <div class="card__dates">
              ...
              <fieldset class="card__repeat-days">
                <div class="card__repeat-days-inner">
                  ...
                  <inputclass="visually-hidden card__repeat-day-input" type="checkbox" id="repeat-th-4" name="repeat" value="th"/>
          ...
          <div class="card__colors-inner">
            ...
            <div class="card__colors-wrap">
              <inputtype="radio" id="color-black-4" class="card__color-input card__color-input--black visually-hidden" name="color" value="black"/>
